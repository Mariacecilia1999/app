...
const ShowTask = ({dataTasks, deleteTask, editTask, completeTask}) =>{
   ...
   return(<>
      <Box sx={{width:{xs:'90vw', sm:'60vw'}}} display='flex' justifyContent='center' flexDirection='column'>
         {dataTasks.map((task)=>{
            return <Box borderBottom='1px solid black' key={task.id} my='30px' display='flex' justifyContent={'space-around'}>
               ...
               <Box width='10vw'  display='flex' justifyContent='space-between' alignItems='center'>
